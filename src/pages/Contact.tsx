        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {contactInfo.map((item) => (
              <Card key={item.title} className="border-0 shadow-soft bg-card hover-lift">
            ...
            <div className="space-y-6">
              <Card className="border-0 shadow-soft bg-card overflow-hidden">
                <CardContent className="p-0">
                  {/* Map placeholder */}
                  <div className="aspect-video bg-gradient-to-br from-soft-teal/30 to-accent flex items-center justify-center relative">
                    <div className="absolute inset-0 opacity-20">
                      <svg viewBox="0 0 400 300" className="w-full h-full">
                        <path
                          d="M50 100 L100 60 L200 40 L300 50 L360 80 L380 140 L370 200 L340 260 L280 290 L180 300 L100 280 L50 230 L30 170 L40 130 Z"
